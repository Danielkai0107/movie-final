...
const HorizontalItem = ({ item }) => {
  ...
  return (
    <li className="horizontalItem">
      <figure className="horizontalItem__poster">
        <img
          src={item?.image}
          alt=""
          onClick={() => {
      ...
      <p className="horizontalItem__title">{item?.name}</p>
      <p className="horizontalItem__date">{item?.date}</p>
    </li>
  );
};
